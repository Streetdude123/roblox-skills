...
- The user under a stand move: a bladed boxing point that holds still. Torso turned 32, the point arm `{58, -10, 80}`, head twist -30 onto the target, lead foot forward 0.3, rear foot back 0.35 turned out 10, root dropped 0.15, a 0.35 Hz breath of 1.5 degrees and nothing else. A 4 frame quart-out whip gets there. "It needs to stay still and point."
