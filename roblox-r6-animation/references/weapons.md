...
## Two-handed spear or lance on R6 (measured 2026-09-26)

- An R6 hand reaches 1.58 studs from its shoulder pivot, and the pivots are 2 studs apart. Both hands reach one shaft only when the rear hand sits at the chest centre (rear arm about 78 degrees across the chest) and the shaft runs 25 to 45 degrees across the chest toward the front-hand side. Straight forward from the chest leaves a 0.46 stud gap.
- Turn the torso side-on (yaw about 35 degrees toward the rear hand) so the crossed shaft points at the target. Key the arms and the shaft in the torso-yaw frame, so the yaw alone aims the weapon; a sweep is the whole body turning.
